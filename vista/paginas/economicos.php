            ...
            <div class="col-sm-12 col-md-12 col-lg-7 col-xl-7 col-xxl-7">
                <center>
                    ...
                    <div class="central mb-1">
                        <div class="notav m-1"> 
                            <div class="clasificados d-flex align-items-center justify-content-center" style="height: 15%;">
                                <h2>Nacional</h2>
                            </div>
                            <div class="notav m-1"> 
                                <div class="clasificados d-flex align-items-center justify-content-center" style="height: 15%;">
                                    <h1><span>Avisos economicos</span></h1>
                                </div>
                                <div class="noticias m-auto d-flex flex-wrap align-content-around" style="height: 85%;">
                                   <div class="aviso m-1">Se necesita vendedor llamar al 956421547</div>
                                   <div class="aviso m-1">Se necesita cuidador de predio llamar al 754462130</div>
                                   <div class="aviso m-1">Se compra vehiculo del 2010 en adelante 755546213</div>
                                   <div class="aviso m-1">Se vende casa con subsidio, telefono 75556213</div>
                                   <div class="aviso m-1">Se necesita arrendar casa urgente 486521358</div>
                                   <div class="aviso m-1">Se necesita guardia nocturno 845547415</div>
                                   <div class="aviso m-1">Compro metales diversos por kilo 784412154</div>
                                   <div class="aviso m-1">Se necesita asesora del hogar puertas adentro 846985123</div>
                                   <div class="aviso m-1">Se necesita programador web sueldo 10.000.000</div>
                                </div>
                            </div>
                        </div>
