    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-7 col-xl-7 col-xxl-7">
                <center>
                    <p><h2>Usuarios registrados</h2></p>
                        ...
                        <center>
                            <?php
                                foreach($usuarios as $user)
                                {
                                    ...
                                    echo "<tr>";
                                    echo "<th>Rut</th>";
                                    echo "<td>".$user["RUT_US"]."</td>";
                                    echo "</tr>";
                                    echo "<tr>";
                                    echo "<th>Nombre completo</th>";
                                    echo "<td>".$user["NOM1_US"]." ".$user["NOM2_US"]." ".$user["APLL1_US"]." ".$user["APLL2_US"]."</td>";
                                    echo "</tr>";
                                    echo "<tr>";
                                    echo "<th>Telefono</th>";
                                    echo "<td>".$user["TEL_US"]."</td>";
                                    echo "</tr>";
                                    echo "<tr>";
                                    echo "<th>Email</th>";
                                    echo "<td>".$user["EMAIL_US"]."</td>";
                                    echo "</tr>";
                                    echo "<tr>";
                                    echo "<th>Ciudad</th>";
                                    echo "<td>".$user["NOM_CIUDAD"]."</td>";
                                    echo "</tr>";
                                    echo "<tr>";
                                    echo "<th>Pais</th>";
                                    echo "<td>".$user["NOM_PAIS"]."</td>";
                                    echo "</tr>";
                                    echo "</table>";
