                    ...
                    <div id="MenuNavegacion" class="collapse navbar-collapse">
                        <ul class="navbar-nav ms-3">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="economicos.php">Registrarse</a></li>
                                <li><a class="dropdown-item" href="privacidad.php">Ver registros</a></li>
                            </ul>
                            <li class="nav-item dropdown">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-7 col-xl-7 col-xxl-7">
                <center>
                    <p><h2>Contactenos!!</h2></p>
                    <div class="central mb-1">
                        <div class="noticias form m-auto" style="height: 85%;">
                            <form action="../../controlador/registro_contacto.php" method="post">
                               <label for="tipo">Seleccione tipo de contacto: </label>
                                <select name="tipo" id="tipo" name="tipo" required>
                                <option value="Seleccionar">Seleccionar...</option>
                                <option value="reclamo" id="reclamo" name="reclamo" >Reclamo</option>
                                <option value="felicitacion" id="felicitacion" name="felicitacion">Felicitacion</option>
                                <option value="sugerencia" id="sugerencia" name="sugerencia">Sugerencia</option>
                                </select>
                                <hr>
                                <label for="nombre">Nombre:&nbsp;&nbsp;</label>
                                <input name="nombre" id="nombre" class="nombre" type="text" placeholder="Nombre" required>
                                <hr>
                                <label for="telefono">Telefono: </label>
                                <input name="telefono" id="telefono" class="telefono" type="tel" maxlength ="9" placeholder="9xxxxxxxx" required>
                                <hr>
                                <label for="email">Email:&nbsp;&nbsp;&nbsp;</label>
                                <input name="email" id="email" class="email" type="email" placeholder="Email" required>
                                <hr>
                                <label for="coment">Comentario:</label><br>
                                <textarea name="coment" id="coment" class="coment" rows="6" cols="35" placeholder="Escriba aqui...." required></textarea><br>
                                <input type="submit" id="publicar" class="boton" name="publicar" value="Enviar">
