                    ...
                    <div id="MenuNavegacion" class="collapse navbar-collapse">
                        <ul class="navbar-nav ms-3">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item btn" href="../../controlador/consult_user.php">Ver registros</a></li>
                            </ul>
                            <li class="nav-item dropdown">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-7 col-xl-7 col-xxl-7">
                <center>
                    <p><h2>Registro de usuarios
                    </h2></p>
                    <div class="central mb-1">
                        <div class="noticias form m-auto" style="height: 85%;">
                        <center><form name ="formulario1" action="../../controlador/registro_user.php" method="post">
                                <hr>
                                <label for="nombre1">1er Nombre:&nbsp;&nbsp;</label>
                                <input name="nombre1" id="nombre" class="nombre" type="text" placeholder="Nombre" required>
                                <hr>
                                <label for="nombre2">2do Nombre:&nbsp;&nbsp;</label>
                                <input name="nombre2" id="nombre" class="nombre" type="text" placeholder="Nombre" required>
                                <hr>
                                <label for="apellido1">1er Apellido:&nbsp;&nbsp;</label>
                                <input name="apellido1" id="nombre" class="nombre" type="text" placeholder="Apellido" required>
                                <hr>
                                <label for="apellido2">2do Apellido:&nbsp;&nbsp;</label>
                                <input name="apellido2" id="nombre" class="nombre" type="text" placeholder="Apellido" required>
                                <hr>
                                <label for="rut" >Rut:&nbsp;&nbsp;</label>
                                <input name="rut" type="text" id="rut" placeholder="Sin puntos ni guion..." maxlength ="9" required>
                                <hr>
                                <label for="telefono">Telefono: </label>
                                <input name="telefono" id="telefono" class="telefono" type="tel" placeholder="9xxxxxxxx" maxlength ="9" required>
                                <hr>
                                <label for="email">Email:&nbsp;&nbsp;&nbsp;</label>
                                <input name="email" id="email" class="email" type="email" placeholder="Email" required>
                                <hr>
                                <label for="pais">Pais:</label>
                                <select id="pais" name="cosa" onchange="cdd()" required>
                                ...
                                <select id="ciudad" name="opt" required>
                                    <option value="-">-</option>
                                </select>
                                <hr>
                                <input type="submit" id="enviar" class="enviar" name="enviar" value="Enviar">
